...
const LivestreamsPage = () => {
    ...
    const fetchLivestreams = async () => {
        try {
            const response = await axios.get("/api/admin/livestreams");
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (selectedLivestream) {
                await axios.patch(`/api/admin/livestreams/${selectedLivestream.id}`, formData);
                toast.success("تم تحديث البث المباشر بنجاح");
            } else {
                await axios.post("/api/admin/livestreams", formData);
    ...
    const handleDelete = async () => {
        ...
        try {
            await axios.delete(`/api/admin/livestreams/${deleteId}`);
    ...
    const handleTogglePublish = async (id: string, currentStatus: boolean) => {
        try {
            await axios.patch(`/api/admin/livestreams/${id}`, { isPublished: !currentStatus });
